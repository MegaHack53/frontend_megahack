  ...
  return (
    <Container>
      <Header>
        ...
        <HeaderTextTotal>R$ 3510</HeaderTextTotal>
      ...
      <CardContainer horizontal={true}>
        {revenue && (
          <Card background="#95BDCE">
            <CardCategory>Receita</CardCategory>
            <CardValue>R$ 3510,00</CardValue>
            <CardPercentage>{/* 20% */}</CardPercentage>
          </Card>
        )}
        {spending && (
          <Card background="#00B2FF">
            <CardCategory>Gastos</CardCategory>
            <CardValue>R$ 3008,60</CardValue>
            <CardPercentage>86%</CardPercentage>
          </Card>
        )}
        {savings && (
          <Card background="#7000FF">
            <CardCategory>Poupado</CardCategory>
            <CardValue>R$ 2,40</CardValue>
            <CardPercentage>{/* 0% */}</CardPercentage>
          </Card>
        )}
        {invest && (
          <Card background="#012940">
            <CardCategory>Investido</CardCategory>
            <CardValue>R$ 500,00</CardValue>
            <CardPercentage>14%</CardPercentage>
          </Card>
        )}
      </CardContainer>
      ...
      <RecentActivities>
        ...
        <ListActivities
          ...
          renderItem={({ item: activity }) => <Activity data={activity} />}
        />
      </RecentActivities>
